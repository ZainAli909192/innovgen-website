...
export async function POST(
  ...
  if (
    ...
    return Response.json(
      {
        message:
          "Please complete all application details and upload your CV.",
      },
      { status: 400 }
    );
  }
  ...
  if (
    ...
    return Response.json(
      {
        message:
          "Please upload a PDF CV no larger than 2 MB.",
      },
      { status: 400 }
    );
  }
...
This message was generated automatically by the InnovGen Careers system.`,
  ...
  // Send confirmation to applicant only
  const { error: applicantError } =
    await resend.emails.send({
      ...
      subject:
        "Your Application Has Been Received — InnovGen",
        ...
        <div style="font-family: Arial, Helvetica, sans-serif; padding: 20px; background: #f5f7fa;">
          <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 10px; padding: 30px; border: 1px solid #e6e9ef;">
            ...
            <p style="font-size: 15px; color: #333; line-height: 1.6;">
              ...
              <strong>InnovGen</strong>.
              This email is to confirm that we’ve successfully received your application.
            </p>

            <p style="font-size: 15px; color: #333; line-height: 1.6;">
              Our recruitment team is currently reviewing your details.
              If your profile matches our requirements, we will contact you regarding the next steps in the selection process.
            </p>

...
function PartnerLeaf({
  ...
  return (
    <motion.button
      ...
      className={`group relative flex min-h-32 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-[1.3rem] border px-3 py-4 text-center shadow-[0_12px_26px_rgb(0_0_0_/_16%)] transition-[border-color,background-color,box-shadow] focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-accent sm:min-h-36 ${active ? "border-accent bg-[linear-gradient(145deg,rgb(26_77_126),rgb(7_28_53))] shadow-[0_16px_36px_rgb(0_0_0_/_26%),0_0_24px_rgb(228_196_119_/_16%)]" : "border-blue-300/25 bg-[linear-gradient(145deg,rgb(15_49_83),rgb(5_22_43))] hover:border-blue-300/70"}`}
    >
      <PartnerLogo partner={partner} decorative={false} className="h-14 w-full max-w-36" />
      <span className="relative mt-3 inline-flex text-xs font-semibold text-foreground sm:text-sm">
...
function PartnerTree({
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-[2rem] border border-blue-300/20 bg-[radial-gradient(circle_at_50%_20%,rgb(31_120_242_/_12%),transparent_28rem),linear-gradient(150deg,rgb(8_31_59_/_96%),rgb(3_14_30_/_98%))] p-4 shadow-[inset_0_1px_0_rgb(255_255_255_/_08%),0_25px_70px_rgb(0_0_0_/_20%)] sm:p-6"
      aria-label="Technology partner directory"
    >
      ...
      <p className="relative mt-6 text-center text-xs font-medium text-blue-200">
        Select any partner logo to explore its capabilities.
      </p>
    </motion.div>
  );
}

...
function MobileServiceWheel({ category }: { category: ServiceCategory }) {
  ...
  return (
    <motion.div
      ref={wheelRef}
      initial={reducedMotion ? false : { opacity: 0, y: 34, rotateX: 12, scale: 0.9 }}
    ...
    >
      ...
      <AnimatePresence mode="wait" initial={false}>
        <motion.div
          ...
          initial={reducedMotion ? false : { opacity: 0, y: 12, rotateX: -6, scale: 0.97 }}
          animate={{ opacity: 1, y: 0, rotateX: 0, scale: 1 }}
          exit={reducedMotion ? { opacity: 0 } : { opacity: 0, y: -8, rotateX: 5, scale: 0.98 }}
...
function ServiceCategoryCloud({ category }: { category: ServiceCategory }) {
  ...
  return (
    ...
    >
      ...
      />
      <motion.div
        initial={reducedMotion ? false : { opacity: 0, y: 28, rotateX: 8, scale: 0.96 }}
        whileInView={{ opacity: 1, y: 0, rotateX: 0, scale: 1 }}
